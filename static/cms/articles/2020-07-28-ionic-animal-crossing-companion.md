...
coverImage: /cms/articles/media/ionic-animal-crossing-companion/cover.jpg
coverImageAlt: ""
showImage: true
...
![Screenshot of Ionic's app creation wizard. It allows you to pick a name, an icon, a template, and a framework to start your app.](/cms/articles/media/ionic-animal-crossing-companion/wizard.jpg)
...
![The wizard gives you a CLI command with an ID for you to run on your machine](/cms/articles/media/ionic-animal-crossing-companion/all-set.jpg)
...
![Screenshot of a browser with browser tools open, and a mobile website with Ionic's default template.](/cms/articles/media/ionic-animal-crossing-companion/initial-template.jpg)
...
![Default folder structure on an Ionic Angular app](/cms/articles/media/ionic-animal-crossing-companion/default-folder-structure.jpg)
...
![Screenshot of Ionic's color generator. When you set primary, secondary, and more colors by giving a HEX value, and Ionic automatically generates shade variants and gives you a live preview.](/cms/articles/media/ionic-animal-crossing-companion/color-generator.jpg)
...
![Gif showing the home screen of my app. The home screen has 4 buttons: Passport, Island, To-Do and Daily Chores. Clicking on them opens a page.](/cms/articles/media/ionic-animal-crossing-companion/skeleton.gif)
...
![The folder structure after my modifications](/cms/articles/media/ionic-animal-crossing-companion/modified-folder-structure.jpg)
...
![GitHub's cool bottom drawer](/images/cms/articles/media/ionic-animal-crossing-companion/github-drawer.gif)
