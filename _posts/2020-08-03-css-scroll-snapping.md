---
layout: post
title: CSS Scroll Snapping - Accurate Scrolling without JS
...
![Android's Recent Apps screen has scroll mapping between app cards]({{page.images-path}}/android-scroll-snapping.gif)
